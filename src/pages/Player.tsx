        ...
        <div className="flex items-center justify-between">
          <div className="flex flex-col gap-1">
            ...
            <span className="text-sm text-zinc-400">
              Módulo "Desenvolvendo o Redux"
            </span>
          </div>

          <button className="flex items-center gap-2 rounded bg-violet-500 px-3 py-2 text-sm font-medium hover:bg-violet-600 transition-colors duration-200">
          ...
          <div className="flex-1">
            <div className="w-full bg-zinc-950 aspect-video">
              <ReactPlayer
                ...
                height="100%"
                controls
                url="https://www.youtube.com/watch?v=1-w1RfGIov4"
              />
            </div>
          </div>
            ...
            <div>
              <button className="flex w-full items-center gap-3 bg-zinc-800 p-4">
                ...
                <div className="flex flex-col gap-1 text-left">
                  <strong className="font-medium">Desvendando o Redux</strong>
